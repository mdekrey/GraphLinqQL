...
namespace GraphLinqQL
{
    public interface IComplexResolverBuilder
    {
        ...
        IComplexResolverBuilder Add(string propertyName, IDictionary<string, string>? parameters = null);
        IComplexResolverBuilder Add(string displayName, string propertyName, IDictionary<string, string>? parameters = null);
